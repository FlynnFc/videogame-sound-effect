...
export const IncorrectEasy = (props) => {
  ...
  const handleSkip = () => {
    props.skipHandler(props.skipsLeft);
  };
          ...
          <div className="relative 	bg-base-100 rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:max-w-lg sm:w-full">
                ...
                <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                  ...
                  <div className="mt-2">
                    <p className="text-md text-base-content ">
                      Sorry, your answer was incorrect 😒. You can skip this
                      question. Or you can start again. You have{" "}
                      <b>{props.skipsLeft}</b> skips left.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="bg-base-100 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
              <button
                ...
                onClick={handleSkip}
                type="button"
                className="btn btn-info w-full inline-flex justify-center rounded-md border border-transparent shadow-sm px-4 py-2 text-base font-medium  sm:ml-3 sm:w-auto sm:text-sm"
              >
                skip
              </button>
